...
body.light-mode .navbar {
    background-color: rgba(244,246,251,.9);
}
...
.nav-link:hover,
.nav-link.active { color: var(--orange-primary); }
...
.project-image-container::before {
    ...
    background: linear-gradient(to bottom, transparent 30%, rgba(6,13,26,.95) 100%);
    z-index: 1;
}
...
.btn-project:hover {
    background: var(--orange-primary);
    color: #fff; border-color: var(--orange-primary);
}
...
.skill-badge {
    ...
    margin: .3rem; border: 1px solid var(--border-color);
    transition: all .25s;
}
...
.skill-grid-card-title i { font-size: 1rem; }
...
.process-step-dot {
    ...
    box-shadow: 0 0 0 6px var(--bg-soft), 0 0 20px rgba(249,115,22,.35);
}
...
.service-icon {
    ...
    border: 1px solid rgba(249,115,22,.2);
    display: flex; align-items: center; justify-content: center;
    font-size: 1.2rem; color: var(--orange-primary);
    margin-bottom: 1rem;
    transition: all .3s;
}
...
.btn-see-more:hover {
    ...
    transform: translateY(-2px); box-shadow: 0 6px 20px rgba(249,115,22,.3);
}
...
@media (max-width: 576px) {
    ...
    .help-button { bottom: 1rem; right: 1rem; }
...
.btn-project:disabled { opacity: .6; cursor: not-allowed; }
</style>
</head>
<body>
            ...
            <div class="col-lg-6">
                ...
                <div class="skill-grid">
                    <div class="skill-grid-card reveal">
                        <p class="skill-grid-card-title">
                            <i class="bi bi-pencil-square"></i>Wireframing
                        </p>
                        <div>
                    ...
                    <div class="skill-grid-card reveal">
                        <p class="skill-grid-card-title">
                            <i class="bi bi-palette2"></i>UI Design
                        </p>
                        <div>
                    ...
                    <div class="skill-grid-card reveal">
                        <p class="skill-grid-card-title">
                            <i class="bi bi-person-check"></i>UX Research
                        </p>
                        <div>
                    ...
                    <div class="skill-grid-card reveal">
                        <p class="skill-grid-card-title">
                            <i class="bi bi-phone"></i>Prototyping
                        </p>
                        <div>
                ...
                <div class="mt-4 reveal">
                    <p style="font-size:.78rem;color:var(--text-muted);text-transform:uppercase;letter-spacing:.1em;font-weight:600;margin-bottom:.75rem;">
                        Design Tools
                    </p>
                    <div>
                ...
                <div class="process-timeline">
                    ...
                    <div class="process-step">
                        ...
                        <div class="process-step-body">
                            ...
                            <p class="process-step-desc">
                                I start by asking: who is the user and what pain are they
                                feeling? Through interviews, competitor analysis, and
                                observing existing workflows, I define the core frustration
                    ...
                    <div class="process-step">
                        ...
                        <div class="process-step-body">
                            ...
                            <p class="process-step-desc">
                                With the problem clearly defined, I generate ideas through
                                sketching, crazy-eights, and collaborative brainstorming.
                                I explore multiple directions before narrowing based on
                    ...
                    <div class="process-step">
                        ...
                        <div class="process-step-body">
                            ...
                            <p class="process-step-desc">
                                Lo-fi wireframes in Figma map out information architecture
                                and screen flows without the distraction of color or imagery.
                                This is where structural decisions are validated with
                                stakeholders cheaply and quickly.
                            </p>
                            <div class="process-outputs">
                    ...
                    <div class="process-step">
                        ...
                        <div class="process-step-body">
                            ...
                            <p class="process-step-desc">
                                Hi-fi mockups apply the design system: brand colors,
                                typography, spacing tokens, and interactive states. I
                                build reusable component libraries and hand off annotated
                                specs for pixel-perfect implementation.
                            </p>
                            <div class="process-outputs">
...
<section id="services" class="services-section section-wrap">
    <div class="container">
        <div class="text-center">
            ...
            <p class="section-description mx-auto">
                What I bring to your team or project — from pixels to production.
            </p>
        </div>
...
<footer class="site-footer">
    <div class="container">
        Designed &amp; built by <span>Ryan Paulo Magnaye</span> &nbsp;·&nbsp;
        <span><?= date('Y') ?></span>
    </div>
</footer>
...
document.getElementById('contactForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        console.error(err);
        showNotif('Sorry, something went wrong. Please try again.', 'error');
    } finally {
        btn.disabled = false;
        btn.innerHTML = orig;
    }
